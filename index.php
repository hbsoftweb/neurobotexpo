...
<body>
    <div class="main">
        <div class="logo-wrapper">
            <img src="assets/images/Neurobot-Logo.svg" alt="" loading="lazy" width="500" height="150" decoding="async"
                data-nimg="1">
        </div>
        <div class="container">
            <div class="form-holder">
                <form>
                    <div>
                        ...
                        <input class="stepper-input" type="text" placeholder="Enter Your Name">
                    </div>
                    <div>
                        <label class="label-input" for="company-name">Company name*</label>
                        <input class="stepper-input" type="text" placeholder="Enter Your Company Name">
                    </div>
                    <div>
                        <label class="label-input" for="contact-number">Contact Number*</label>
                        <input class="stepper-input" type="number" placeholder="Enter Your Phone number">
                    </div>
                    <div>
                        <label class="label-input" for="email">Email*</label>
                        <input class="stepper-input" type="email" placeholder="Enter Your Email">
                    </div>
                    <div>
                        ...
                        <div>
                            <input class="stepper-input" type="text" placeholder="Other Designation">
                        </div>
                    </div>
                    <div>
                        <label class="label-input" for="industry">Industry*</label>
                        <div class="checkbox-group">
                            <div class="radio-inputs">
                                <label>
                                    <input class="radio-input" type="radio" value="Purchase Head" name="designation">
                                    <span class="radio-tile">
                                        <span class="radio-icon">
                                            <img alt="Purchase Head" loading="lazy" width="97" height="97"
                                                decoding="async" data-nimg="1" class="radio-icon-img"
                                                src="assets/images/Pharma.svg" style="color: transparent;">
                                        </span>
                                ...
                                <label>
                                    ...
                                    <span class="radio-tile">
                                        <span class="radio-icon">
                                            <img alt="Purchase Head" loading="lazy" width="97" height="97"
                                                decoding="async" data-nimg="1" class="radio-icon-img"
                                                src="assets/images/Packaging.svg" style="color: transparent;">
                                        </span>
                                ...
                                <label>
                                    ...
                                    <span class="radio-tile">
                                        <span class="radio-icon">
                                            <img alt="Decision Maker" loading="lazy" width="96" height="96"
                                                decoding="async" data-nimg="1" class="radio-icon-img"
                                                src="assets/images/Automotive.svg" style="color: transparent;">
                                        </span>
                            ...
                            <div class="radio-inputs">
                                <label>
                                    ...
                                    <span class="radio-tile">
                                        <span class="radio-icon">
                                            <img alt="Other" loading="lazy" width="97" height="97" decoding="async"
                                                data-nimg="1" class="radio-icon-img" src="assets/images/Electronics.svg"
                                                style="color: transparent;">
                                        </span>
                        ...
                        <div>
                            <input class="stepper-input" type="text" placeholder="Other Industry">
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <div class="application-wrapper">
                                ...
                                <div class="checkbox-group-application">
                                    ...
                                    <div class="radio-inputs">
                                        <label>
                                            <input class="radio-input" type="checkbox" value="1200e" name="application">
                                            <span class="radio-tile radio-tile-application">
                                                <span class="radio-icon"></span>
                                    ...
                                    <div class="radio-inputs">
                                        <label>
                                            <input class="radio-input" type="checkbox"
                                                value="7inch Touch Screen Microscope" name="application">
                                            <span class="radio-tile radio-tile-application">
                                                <span class="radio-icon"></span>
